...
4,607 employers tracked · data as of Sep 21, 2026 at 01:51 UTC
...
_Engine (last run): 4,422 of 4,866 registered boards returned successfully across 12 ATS platforms (96% of boards attempted, 90% of the full registry) · completed in 1057.8s · 568 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
