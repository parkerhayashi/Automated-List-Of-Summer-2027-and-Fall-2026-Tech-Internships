...
### 65 open roles (47 listed below) · 37 new this week

4,562 employers tracked · data as of Sep 15, 2026 at 17:58 UTC

_32 have a cycle the employer stated · 33 are recent postings whose cycle isn't stated (listed separately, never mixed in)._
...
| ⚙️ **An engine, not a spreadsheet** | 4,816 job-board endpoints (4,562 distinct employers; some run more than one board) polled every 30 minutes across 12 ATS platforms. Full source and tests in this repo. |
...
_Engine (last run): 4,409 of 4,816 registered boards returned successfully across 12 ATS platforms (97% of boards attempted, 91% of the full registry) · completed in 1177.6s · 618 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
